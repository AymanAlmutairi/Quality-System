    ...
    <section class="register register-login">
        <div class="register-overlay  register-login-overlay">
            <div class="container-fluid">
                <form class="row justify-content-center needs-validation" novalidate action="{{ route('courses.store') }}"
                    method="POST">
                    @csrf
                    ...
                    <div class="col-lg-3 col-md-6 col-sm-6 col-xs-12">
                        <div class="form-group">
                            <input type="date" name="start_date" id="reportDateCourse" class="form-control"
                                placeholder="Report Date*" required>
                    ...
                    <div class="col-lg-3 col-md-6 col-sm-6 col-xs-12">
                        <div class="form-group">
                            <input type="text" min="1" name="tutorial" id="tutorialCourse"
                                class="form-control" placeholder="Tutorial*" required>
                            <div class="invalid-feedback">Please Enter a Tutorial.</div>
                        </div>
                    </div>
                    <div class="col-lg-3 col-md-6 col-sm-12 col-xs-12">
                        <div class="form-group">
                            <input type="text" min="1" name="others" id="othersCourse"
                                class="form-control" placeholder="Others ( Specify )*" required>
